...
import SingUpWihGoggle from "../SignUp/SingUpWihGoggle";
        ...
        <div className="flex justify-center min-h-screen bg-gray-100">
          <div className="container sm:mt-40 mt-24 my-auto max-w-md border-2 border-gray-200 p-3 bg-white rounded-2xl">
            <div className="text-center my-3">
              <h1 className="text-3xl font-semibold text-indigo-400">Login</h1>
            </div>
            <div className="m-6">
              <form className="mb-4" onSubmit={handleSubmit} method="post">
                ...
                <div className="mb-2">
                  <button
                    type="button"
                    className="w-full px-3 py-2 text-black border border-indigo-600 hover:bg-indigo-600 focus:outline-none duration-100 ease-in-out rounded-3xl hover:shadow-lg"
                  >
                    Forgoten password
                  </button>
                </div>
