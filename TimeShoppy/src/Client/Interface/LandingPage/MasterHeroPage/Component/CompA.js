      ...
      <div className=" md:px-40">
        ...
        <div className="relative mx-auto flex flex-col items-start justify-start w-full max-w-xl px-4 md:px-0 lg:px-8 lg:max-w-screen-xl">
          <div className="mb-16 lg:my-40 lg:max-w-lg lg:pr-5">
            <h1 className="text-[64px] leading-none lg:text-5xl tracking-wider sm:text-center  font-Jacques md:text-left">
              Shop near you <div className="pt-3">easily & on-time</div>
            </h1>
            <p className="text-[28px] leading-none md:text-2xl lg:text-3xl py-7 text-sm text-left font-sans font-light">
              Variety of stores with unique and{" "}
              <span>ordinary spanroducts just for you!</span>
            </p>
            <div className="md:flex items-start">
              <button className="bg-[#FF4C3B] px-[56px] py-[24px] text-white rounded-full cursor-pointer font-san font-[28px]">
                Explore Products
              </button>
            </div>
          </div>
